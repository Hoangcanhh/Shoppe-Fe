...
import shoppe from '../assets/shoppe-logo.png'
import authorzeAxiosInstance from '~/utils/authorizedAxios'
...
function Login() {
  ...
  const submitLogIn = async (data) => {
    const res = await authorzeAxiosInstance.post(`${API_ROOT}/v1/users/login`, data)
    ...
    //điều hướng tời trang dashboards nếu login thành công
    navigate('/dashboards')
  }
        ...
        <Zoom in={true} style={{ transitionDelay: '200ms' }}>
          <MuiCard sx={{ minWidth: 380, maxWidth: 380, marginTop: '6em', p: '0.5em 0', borderRadius: 2 }}>
            <Box sx={{ width: '70px', bgcolor: 'white', margin: '0 auto' }}>
              <img src={shoppe} alt='trungquandev' width='100%' />
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'center', color: theme => theme.palette.grey[500] }}>
              <Box>
                <Typography>Hint: canhhoang@gmail.com</Typography>
                ...
                <TextField
                  ...
                  sx={{
                    '& .MuiOutlinedInput-root': {
                      // '& fieldset': {
                      //   borderColor: '#FF5722', // Viền màu cam khi bình thường
                      // },
                      '&:hover fieldset': {
                        borderColor: '#E64A19', // Viền cam đậm hơn khi hover
                      },
                    ...
                    '& .MuiInputLabel-root': {
                      '&.Mui-focused': {
                        color: '#FF5722', // Màu cam cho label khi focus
                      },
                    },
                  }}
                />
            ...
            <CardActions sx={{ padding: '0.5em 1em 1em 1em' }}>
              <Button
                ...
                fullWidth
                sx={{
                  bgcolor: '#FF5722', // Nút màu cam
                  ':hover': {
                    bgcolor: '#E64A19', // Màu hover đậm hơn
                  },
                }}
              >
                Login
